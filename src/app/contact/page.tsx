...
export default function Contact() {
  ...
  return (
    <main className="min-h-screen">
      ...
      <section className="w-full min-h-screen flex flex-col items-center justify-center pt-8 md:pt-0 px-4 md:px-16 pb-12 md:pb-0">
        {" "}
        {/* Ajustes de padding y min-h-screen */}
        <div className="max-w-[1440px] min-h-[1000px] w-full flex flex-col-reverse md:flex-row gap-8 md:gap-20 justify-center items-center">
          {" "}
          {/* Cambiado a flex-col en móvil, ajuste de gap */}
          <div className="flex flex-col md:flex-row w-full border border-[var(--secondary-border-color)] rounded-2xl p-6 md:p-16 mt-8 md:mt-0 gap-10">
            {" "}
            {/* w-full en móvil, padding y margin top ajustados */}
            ...
            <div className="w-full md:w-[50%] flex flex-col gap-10 rounded-2xl overflow-hidden">
              <div
                className="border border-[var(--secondary-border-color)] rounded-2xl relative
                            "
              >
                <Image
                  src="/map3.PNG"
              ...
              <div className="border border-[var(--secondary-border-color)] rounded-2xl relative p-10 flex flex-col align-start justify-start gap-3 md:gap-6">
                ...
                <div className="flex space-x-6 justify-center md:justify-start text-white mt-4 md:mt-0">
                  {" "}
                  {/* Ajuste de alineación y margin top para mobile */}
                  <Link
                  ...
                  <Link href="https://x.com/home" aria-label="X (Twitter)">
