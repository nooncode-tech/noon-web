    ...
    <main className="min-h-screen text-white">
      ...
      <section className="h-[40vh] md:h-[80vh] w-full flex flex-col md:flex-row items-center md:items-center justify-center px-6 md:px-16 background-about relative overflow-hidden gap-8 border-b border-[var(--secondary-border-color)]">
        <div className="w-full md:w-[50%] flex flex-col items-center md:items-end justify-center relative text-center md:text-right px-4 md:px-0">
          ...
          <p className="hero-title-p max-w-[465px] mt-4 text-[14px]">
            ...
            With 500+ expert developers and a results-driven approach, we
            deliver efficient, high-quality technology tailored to your goals.
          </p>
        </div>
        ...
        <div className="w-full md:w-[50%] relative h-64 md:h-full hidden md:flex items-center justify-start md:justify-center">
          <Image
            ...
            style={{
              ...
              maskImage:
                "linear-gradient(to right, rgba(15, 14, 43, 1) 0%, rgba(15, 14, 43, 0.1) 80%)",
              WebkitMaskImage:
                "linear-gradient(to right, rgba(15, 14, 43, 1) 0%, rgba(15, 14, 43, 0.1) 80%)",
            }}
          />
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-12">
          ...
          <div className="text-center">
            ...
            <p className="max-w-[600px] text-white text-center text-[14px] my-10 md:my-6 m-auto">
              At Noon, our team comprises highly qualified developers,
              designers, and technology specialists dedicated to delivering
              excellence. We operate with precision, collaboration, and a clear
              focus on achieving our clients' objectives.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-12">
          ...
          <div className="text-center flex flex-col items-center">
            ...
            <p className="max-w-[600px] text-white text-center text-[14px] mt-6 md:my-6 m-auto">
              Clear steps. Reliable results. At Noon, we follow a streamlined
              process that keeps you involved and your project on track—from the
              first visual prototype to final delivery. Our method ensures
              speed, precision, and full alignment with your vision.
            </p>
              ...
              {[
                ...
                >
                  ...
                  >
                    ...
                    <p className="text-[12px]">{step.desc}</p>
                  </div>
                </MotionEffect>
              ))}
            </div>
        ...
        <div className="max-w-7xl mx-auto flex flex-col gap-8 px-0 md:px-12 md:flex-row md:gap-10">
          ...
          <div className="w-full flex flex-col items-center justify-center relative md:w-[50%] md:flex-col md:items-center md:justify-center">
            ...
            <div className="w-full max-w-[400px] space-y-4">
              <h3 className="text-lg font-semibold text-white Riosark mb-4">
                Our Expertise
              </h3>
              <ProgressBar
              ...
              />
              <ProgressBar
                label="Agile & Scalable Delivery"
                percentage={95}
                color="green"
              />
              <ProgressBar
                label="Client-Centered Communication"
                percentage={92}
                color="purple"
              />
              <ProgressBar
                label="Cutting-Edge Tech Solutions"
                percentage={96}
                color="orange"
              />
            </div>
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm text-gray-300">
                    Internal QA and Delivery Standards Audited Quarterly
                  </span>
                </div>
                <div className="flex items-center gap-3">
      ...
      <section className="w-full flex justify-center items-center flex-col px-8 md:px-16 border-b border-[var(--secondary-border-color)] py-10 md:py-30">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-[1440px] w-[90%] md:w-[70%]">
          <div
            className="flex flex-col justify-center items-center py-10 md:py-10 rounded-xl boxes-services-style"
            style={{
              boxShadow:
                "0 6px 32px 0 rgba(59, 46, 185, 0.35), 0 1.5px 3px 0 rgba(255,255,255,0.12)",
            }}
          >
            <div className="flex flex-col items-center text-center px-10">
              ...
              <p className="text-gray-300 max-w-[544px] text-center pt-4 text-[14px]">
                To develop tailored technological solutions that drive growth
                and digital transformation for our clients, delivering quality,
          ...
          >
            <div className="flex flex-col items-center text-center px-10">
              ...
              <p className="text-gray-300 max-w-[544px] text-center pt-4 text-[14px]">
                To become a global leader in technology development, recognized
                for the excellence of our services, our commitment to clients,
                and our ability to turn ideas into scalable, real-world
                solutions.
              </p>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-12">
          ...
          <div className="text-center flex flex-col items-center">
            ...
            <p className="max-w-[900px] text-white text-center text-[14px] mt-6 md:mt-10 m-auto">
              ...
              supports. More than just developing software, we help our clients
              move forward with confidence, clarity, and results.
            </p>
          </div>
        </div>
      </section>
