...
const Navbar = () => {
    ...
    return (
        <div className="flex align-center absolute top-0 z-50 w-full">
            <nav className="max-w-[1440px] mx-auto py-4 px-8 md:py-8 md:px-16 flex justify-between items-center w-full">
                {/* Logo */}
                <div>
