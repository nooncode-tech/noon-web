...
const menuItems = [
  ...
  { label: "About Us", path: "/about" },
  {
    ...
    path: "/contact",
    className:
      "navbar-button flex gap-3 justify-center items-center text-white hover:text-[var(--principal-background-color)]!",
  },
];
        ...
        <Sheet open={isOpen} onOpenChange={setIsOpen}>
          <SheetTrigger asChild>
            <Button
              variant="ghost"
              size="icon"
              className="md:hidden text-white hover:text-gray-200 hover:bg-gray-700"
            >
          ...
          <SheetContent
            side="right"
            className="w-[300px] bg-[var(--principal-background-color)] border-gray-700 p-0 [&>button]:hidden h-[100vh]"
          >
