...
export default function LandingPage() {
  return (
    ...
    const [text, { isDone }] = useTypewriter({
        words: [code],
        typeSpeed: Math.max(1, Math.floor(3000 / code.length)),
        deleteSpeed: 99999,
        delaySpeed: 99999,
        loop: 1
    })
    ...
    return (
        ...
        >
            ...
            <div className={`flex ${theme === "dark" ? "bg-[var(--principal-background-color)]" : "bg-gray-50"}`} style={{height: '500px', minHeight: 0}}>
                ...
                <div
                    ...
                    style={{ minHeight: 0 }}
                >
                    <div className="flex" style={{height: '500px', minHeight: 0}}>
                        {/* Números de línea */}
                        <div
                            className={`
